...
public class TargetRadialBurstBullet : MonoBehaviour
{
    [Header("Projectile Settings")]
    public int numberOfProjectiles;         // number of the direction
    public float projectileSpeed;
    public float timeToFire = 0.5f;         // the time enemy start to fire after spawn
    public float burstTime = 1f;
    public int bulletAmount = 10;           // number of bullets per burst
